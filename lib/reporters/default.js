 ...
 * each given match. By default, paths are absolute, but can be made relative
 * by setting opts.relative to true. If enabled via opts.diff, corresponding
 * diffs are also printed.
 *
 * @constructor
 *
